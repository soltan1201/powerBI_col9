...
st.set_page_config(
        page_title="Dashboard Maps Validation", 
        page_icon="📈", 
        layout="wide", 
...
def load_data_Areas(nameBac, xvers, modelo_act):
    ...
    print("lista de colunas tabela Areas \n", dfAggBacia.columns)
...
modelos = ['RF', 'GTB']
# 'Gap-fill', 'Spatial', 'Temporal', 'Frequency',
posclass = [
    'TemporalV3J5','SpatialV3su','SpatialV3','FrequencyV3','FrequencyV3St1',"Estavel",'TemporalV3J3','TemporalV3J4','toExport'   
]
dictModel = {
    'Random Forest': 'RF', 
...
vers = ['41','40','38','37','36','35','34','33','32','31','30','25', '26', '28', '29'] #  '6', '7', '11', '12',
nameBacias = [
